...
def process_frame(
    ...
    cv2.putText(frame_bgr, f"EAR: {ear_val:.3f}", (10, 48), cv2.FONT_HERSHEY_SIMPLEX, 0.5, (255, 255, 255), 1)
    cv2.putText(frame_bgr, f"Posture: {posture_status}", (10, 70), cv2.FONT_HERSHEY_SIMPLEX, 0.6, posture_color, 2)
    cv2.putText(frame_bgr, f"Health: {health_score:.0f}/100", (10, 93), cv2.FONT_HERSHEY_SIMPLEX, 0.5, (255, 255, 0), 2)
    ...
    class VisionMateTransformer(VideoTransformerBase):
        ...
        def recv(self, frame: "av.VideoFrame") -> "av.VideoFrame":
            ...
            if self._frame_count % self.FRAME_SKIP == 0:
                ...
                cv2.putText(img_bgr, f"EAR: {last.ear_value:.3f}", (10, 48), cv2.FONT_HERSHEY_SIMPLEX, 0.5, (255, 255, 255), 1)
                cv2.putText(img_bgr, f"Posture: {last.posture_status}", (10, 70), cv2.FONT_HERSHEY_SIMPLEX, 0.6, posture_color, 2)
                cv2.putText(img_bgr, f"Health: {last.health_score:.0f}/100", (10, 93), cv2.FONT_HERSHEY_SIMPLEX, 0.5, (255, 255, 0), 2)
